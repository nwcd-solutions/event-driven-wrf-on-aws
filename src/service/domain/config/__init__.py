...
__all__ = ['WrfConfig', 'ConfigDao','add_config_to_system', 'add_config_to_system', 'get_config_from_system',
           'get_all_configs_in_system', 'update_config_in_system', 'delete_config_from_system','LatLonPoint']

from typing import Union, List
from config.config import WrfConfig
from config.config_dao import ConfigDao
...
def get_all_configs_in_system() -> List[WrfConfig]:
    ...
    print("get all configs in system")
    dao = ConfigDao()
...
def update_config_in_system(update_config: WrfConfig) -> bool:
    ...
    if existing_config is None:
        print('The model configuration does not exist and cannot be updated: ' + update_config.name)
        return False
...
def delete_config_from_system(del_config: WrfConfig) -> bool:
    ...
    print('Value for config to remove was set as None', ValueError('del_config cannot be None'))
    return False
