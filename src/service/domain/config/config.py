...
from config.latlonpoint import LatLonPoint
...
class WrfConfig:
    ...
    def sanitized_data(self) -> Union[dict, None]:
        ...
        try:
            ...
            print('Failed to sanitize WRF configuration data', e)
            return None
        return data
    ...
    def _compute_domain_center_and_size(self):
        ...
        try:
            ...
            print('Failed to compute the domain center and size from namelist.wps', e)
    ...
    def validate(self) -> bool:
        ...
        if match is None:
            print(f'name is invalid: {self.name}')
            return False
        return True
    ...
    def _calculate_optimal_core_count(self) -> int:
        ...
        if isinstance(nx, int):
            ...
            print('Could not read e_we/e_sn from WPS namelist')
            return 96
